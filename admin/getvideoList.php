...
//total num
$totalquery = $db->fetch_first("select count(*) as num from tp_videos where status=1");
...
foreach($datalist as $datatemp){
	...
	$item[] = number_format($datatemp['visitcount']);
	$item[] = '<a class="btn btn-success" target="_blank" href="http://www.topwindata.com/windows10videos/'.$datatemp['urlalias'].'.html">
                <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                View
            </a>
            <a class="btn btn-info" href="videoedit.php?id='.$datatemp['id'].'">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a id="deleteitem'.$datatemp['id'].'" class="btn btn-danger" href="javascript:deletevideo(\''.$datatemp['id'].'\');">
